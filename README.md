...
# 💣 友情提示
1. 该项目提供的链接只是一个演示地址，并不能作为工具使用，也不提供任何在线服务。
2. 该项目的目标是打造一个 “在线幻灯片应用” ，而非 “低代码平台”、“H5 编辑器” 或 “在线图片编辑工具” 等。
3. 该项目不接受任何形式的私人咨询，有任何问题欢迎在 github 提交你的 [Issues](https://github.com/pipipi-pikachu/PPTist/issues)