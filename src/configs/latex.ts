...
export const FORMULA_LIST = [
  {
    label: t('Commons.label.text_jydnp6'),
...
export const SYMBOL_LIST = [
  {
    type: 'operators',
    label: t('Commons.label.text_hr7a'),
    children: [
      { latex: '\\cdot' },
      { latex: '\\pm' },
      { latex: '\\mp' },
  ...
  {
    type: 'group',
    label: t('Commons.label.text_m0uc'),
    children: [
      { latex: '\\frac{a}{b}' },
      { latex: '\\frac{dx}{dx}' },
  ...
  {
    type: 'verbatim',
    label: t('Commons.label.text_ei37'),
    children: [
      { latex: '\\log' },
      { latex: '\\ln' },
      { latex: '\\exp' },
  ...
  {
    type: 'greek',
    label: t('Commons.label.text_ceezdg'),
    children: [
      { latex: '\\alpha' },
      { latex: '\\beta' },
      { latex: '\\gamma' },
