<template>
  <MoveablePanel 
    ...
    :width="300" 
    :height="560" 
    :title="$t('Commons.text.text_slide_n', { n: slideIndex + 1 })"
    :left="-270" 
    :top="90"
    :minWidth="300"
    :minHeight="400"
    ...
    <div class="container">
      ...
      <div class="send">
        <TextArea 
          ...
          :padding="6"
          :placeholder="`${$t('Commons.text.text_igbi9t')}（${handleElementId ? $t('Commons.text.text_ihv1j5') : $t('Commons.text.text_xfy8mw')}）`"
          :rows="2"
