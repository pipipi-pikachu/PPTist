<template>
  <div class="shape-style-panel">
    ...
    <div class="row">
      ...
      >
        <SelectOption value="fill">{{t('shapeStyle.fill')}}</SelectOption>
        <SelectOption value="gradient">{{t('shapeStyle.gradient')}}</SelectOption>
      </Select>
      ...
      <Select
        ...
        v-else
      >
        <SelectOption value="linear">{{t('shapeStyle.linear')}}</SelectOption>
        <SelectOption value="radial">{{t('shapeStyle.radial')}}</SelectOption>
      </Select>
    </div>

    <template v-if="fillType === 'gradient'">
      <div class="row">
        <div style="flex: 2;">{{t('shapeStyle.startWith')}}：</div>
      ...
      <div class="row">
        <div style="flex: 2;">{{t('shapeStyle.endWith')}}：</div>
        <Popover trigger="click">
          <template #content>
            <ColorPicker
      ...
      <div class="row" v-if="gradient.type === 'linear'">
        <div style="flex: 2;">{{t('shapeStyle.angle')}}：</div>
        <Slider
          class="slider"
          :min="0"
          :max="360"
    ...
    <template v-if="handleShapeElement.text?.content">
      ...
      <ButtonGroup class="row">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" :title="t('textStyle.fontSizeMinus')">
          <Button
            class="font-size-btn"
            style="flex: 2;"
      ...
      >
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" :title="t('textStyle.alignTop')">
          <RadioButton value="top" style="flex: 1;"><IconAlignTextTopOne /></RadioButton>
        </Tooltip>
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" :title="t('textStyle.alignMiddle')">
          <RadioButton value="middle" style="flex: 1;"><IconAlignTextMiddleOne /></RadioButton>
        </Tooltip>
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" :title="t('textStyle.alignBottom')">
