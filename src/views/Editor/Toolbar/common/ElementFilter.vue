<template>
  <div class="element-filter">
    <div class="row">
      <div style="flex: 2;">{{ $t('Commons.text.text_ar00nr', {}) }}</div>
...
const defaultFilters: FilterOption[] = [
  { label: t('Commons.text.text_iqix'), key: 'blur', default: 0, value: 0, unit: 'px', max: 10, step: 1 },
  { label: t('Commons.text.text_dwhk'), key: 'brightness', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: t('Commons.text.text_dztvv'), key: 'contrast', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: t('Commons.text.text_jn7a'), key: 'grayscale', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: t('Commons.text.text_mvzrf'), key: 'saturate', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: t('Commons.text.text_mu9y'), key: 'hue-rotate', default: 0, value: 0, unit: 'deg', max: 360, step: 10 },
  { label: t('Commons.text.text_o12a'), key: 'sepia', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: t('Commons.text.text_f1hb'), key: 'invert', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: t('Commons.text.text_afzure'), key: 'opacity', default: 100, value: 100, unit: '%', max: 100, step: 5 },
]
...
const presetFilters: {
  ...
  { label: t('Commons.text.text_rnws'), values: { 'grayscale': '100%' } },
  { label: t('Commons.text.text_flvb'), values: { 'sepia': '50%', 'contrast': '110%', 'brightness': '90%' } },
  { label: t('Commons.text.text_pt6u'), values: { 'contrast': '150%' } },
  { label: t('Commons.text.text_i4hk'), values: { 'brightness': '110%', 'contrast': '90%' } },
  { label: t('Commons.text.text_i5y4'), values: { 'sepia': '30%', 'saturate': '135%' } },
  { label: t('Commons.text.text_hsgw'), values: { 'brightness': '110%', 'contrast': '110%' } },
  { label: t('Commons.text.text_rcrb'), values: { 'saturate': '200%' } },
  { label: t('Commons.text.text_iqix'), values: { 'blur': '2px' } },
  { label: t('Commons.text.text_f1hb'), values: { 'invert': '100%' } },
]
