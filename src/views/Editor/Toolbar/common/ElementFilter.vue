...
const defaultFilters: FilterOption[] = [
  ...
  { label: 'Saturate', key: 'saturate', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: 'Hue-rotate', key: 'hue-rotate', default: 0, value: 0, unit: 'deg', max: 360, step: 10 },
...
const presetFilters: {
  ...
  { label: 'Warm color', values: { 'sepia': '30%', 'saturate': '135%' } },
  { label: 'Bright', values: { 'brightness': '110%', 'contrast': '110%' } },
  { label: 'Saturated', values: { 'saturate': '200%' } },
  { label: 'Blurred', values: { 'blur': '2px' } },
  { label: 'Inverted', values: { 'invert': '100%' } },
]
