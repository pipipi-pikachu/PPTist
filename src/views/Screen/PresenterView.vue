<template>
  <div class="presenter-view">
    <div class="toolbar">
      ...
      <div class="tool-btn" :class="{ 'active': writingBoardToolVisible }"
        @click="writingBoardToolVisible = !writingBoardToolVisible">
        <IconWrite class="tool-icon" /><span>Brush</span>
      </div>
      ...
      <div class="tool-btn" @click="exitScreening()">
        <IconPower class="tool-icon" /><span>End Screening</span>
      </div>
    </div>
    <div class="content">
      <div class="slide-list-wrap" :class="{ 'laser-pen': laserPen }" ref="slideListWrapRef">
        ...
        <WritingBoardTool :slideWidth="slideWidth" :slideHeight="slideHeight" :left="-365" :top="-155"
          v-if="writingBoardToolVisible" @close="writingBoardToolVisible = false" />
        <CountdownTimer v-if="timerlVisible" :left="75" @close="timerlVisible = false" />
      </div>
    ...
    <div class="remark">
      ...
      <div class="remark-scale">
        <div :class="['scale-btn', { 'disable': remarkFontSize === 12 }]" @click="setRemarkFontSize(remarkFontSize - 2)">
          <IconMinus />
        </div>
        <div :class="['scale-btn', { 'disable': remarkFontSize === 40 }]" @click="setRemarkFontSize(remarkFontSize + 2)">
          <IconPlus />
        </div>
      </div>
    </div>
