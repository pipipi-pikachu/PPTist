    ...
    test('should fail with bad args', () => {
        ...
        assertThrows(() => {
            new SVGPathData('m20,30l10,10z')
                .matrix(...[1])
                .encode();
        }, Error, 'assertNumbers arguments[1] is not a number. undefined == typeof undefined');
        assertThrows(() => {
            new SVGPathData('m20,30l10,10z')
                .matrix(...[1, 1])
                .encode();
        }, Error, 'assertNumbers arguments[2] is not a number. undefined == typeof undefined');
        assertThrows(() => {
            new SVGPathData('m20,30l10,10z')
                .matrix(...[1, 1, 1])
                .encode();
        }, Error, 'assertNumbers arguments[3] is not a number. undefined == typeof undefined');
        assertThrows(() => {
            new SVGPathData('m20,30l10,10z')
                .matrix(...[1, 1, 1, 1])
                .encode();
        }, Error, 'assertNumbers arguments[4] is not a number. undefined == typeof undefined');
        assertThrows(() => {
            new SVGPathData('m20,30l10,10z')
                .matrix(...[1, 1, 1, 1, 1])
                .encode();
        }, Error, 'assertNumbers arguments[5] is not a number. undefined == typeof undefined');
    });
    test('for scale', () => {
